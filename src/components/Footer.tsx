        ...
        <div className="flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="text-center md:text-right">
            <div className="flex items-center justify-center md:justify-end space-x-6 mb-4">
              ...
              <a href="#portfolio" className="nav-link text-sm">Portfolio</a>
              <a href="#tech" className="nav-link text-sm">Technologies</a>
              <a href="#contact" className="nav-link text-sm">Contact</a>
            </div>
            
            <p className="text-sm text-foreground/70">
              © {currentYear} • Game Developer Portfolio • Made with <Heart size={14} className="inline text-coral" /> using React & Tailwind
            </p>
          </div>
        </div>
      </div>
